...
#ifndef ROBORTS_DETECTION_ARMOR_DETECTION_CONSTRAINT_XDU_H
#define ROBORTS_DETECTION_ARMOR_DETECTION_CONSTRAINT_XDU_H
 ...
 */
class ConstraintXdu : public ArmorDetectionBase {
 public:
  ConstraintXdu(std::shared_ptr<CVToolbox> cv_toolbox);
  /**
...
roborts_common::REGISTER_ALGORITHM(ArmorDetectionBase, "constraint_set", ConstraintXdu, std::shared_ptr<CVToolbox>);

} //namespace roborts_detection

#endif // AOTO_PILOT_DETECTION_ARMOR_DETECTION_CONSTRAINT_XDU_H
